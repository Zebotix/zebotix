  ...
  const portfolios = [
    {
      ...
      problem:
        `<p>The client was struggling with a slow, bloated AngularJS dashboard that took over 10 seconds to load financial data. This latency was causing significant operational delays for their internal analysts who needed real-time data to make split-second trading and investment decisions. The legacy architecture was tightly coupled, making it nearly impossible to implement new features or integrate modern charting libraries without risking systemic failures.</p>`,
      solution:
        `<p>We engineered a complete architectural overhaul, migrating the entire application to a modern Next.js framework. We utilized server-side rendering (SSR) for the initial data loads to ensure immediate visibility, and integrated optimistic UI updates for subsequent user interactions.</p>
      ...
      results: {
        ...
        summary: "Load times dropped from 10 seconds to under 1 second. User engagement increased dramatically as analysts could process reports in a fraction of the time."
      },
      techStack: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "Redis", "tRPC"],
      gallery: ["https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000", "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1000"],
      isPublished: true,
    },
    {
      ...
      results: {
        ...
        summary: "Support ticket resolution times dropped from 24 hours to 2 minutes, saving the company over $500,000 annually in support costs."
      },
