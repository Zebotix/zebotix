...
const Footer = () => {
  ...
  const companyLinks = [
    ...
    { name: 'Portfolio (Coming Soon)', href: '#', disabled: true },
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.15}>
              <p className="text-zinc-400 text-xs max-w-lg leading-relaxed">
                Sign up for our newsletter to receive technical briefs on architecture, web optimization, and modern software design patterns.
              </p>
            </Reveal>
          </div>
          <div className="lg:col-span-5 flex items-end">
            <Reveal delay={0.3} className="w-full">
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-0 w-full border border-zinc-850">
                <input
                  type="email"
                  value={email}
                  ...
                  required
                  className="bg-zinc-900 border-0 focus:ring-0 focus:outline-hidden p-4 text-xs text-white placeholder-zinc-550 flex-grow rounded-none"
                />
                <Button
                  type="submit"
                  disabled={loading}
        ...
        {/* Links Columns Grid - aligned correctly */}        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 pt-12 sm:pt-16 pb-8 sm:pb-12">
          {/* Column 1: Info */}
          <Reveal distance={30}>
            <div className="flex flex-col">
              ...
              >
                <div className="w-8 h-8 bg-blue-600 rounded-none flex items-center justify-center border border-blue-500/20">
          ...
          <Reveal delay={0.3} distance={30}>
            <div className="flex flex-col">
              ...
              <div className="pt-4 border-t border-zinc-900">
                <nav aria-label={`${COMPANY_NAME} social links`} className="flex flex-wrap gap-x-4 gap-y-2">
        ...
        <div className="select-none text-center block mt-8 pt-8 border-t border-zinc-900 hidden sm:block">
