...
const Footer = () => {
  ...
  return (
    <footer className='bg-zebotix-black border-t border-white/5 pt-20 pb-10 overflow-hidden' role='contentinfo'>
      <div className='max-w-7xl mx-auto px-6 sm:px-8 lg:px-12'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8'>
          {/* Company info */}
          <Reveal distance={30} className='col-span-1 sm:col-span-2 lg:col-span-1'>
            <div>
              <Link href='/' className='inline-block mb-8 group' aria-label={`${COMPANY_NAME} homepage`}>
                <Image
                  src='/Zebotix.png'
                  alt={COMPANY_NAME}
                  width={80}
              ...
              <p className='text-gray-400 mb-8 text-base leading-relaxed max-w-sm'>
                Empowering businesses with intelligent software & AI solutions. 
                We architect digital products that scale with your vision.
              </p>
          ...
          <Reveal delay={0.1} distance={30}>
            <nav aria-label='Quick links'>
              <h3 className='text-white font-black text-xs uppercase tracking-widest mb-8'>Solutions</h3>
          ...
          <Reveal delay={0.2} distance={30}>
            <nav aria-label='Company links'>
              <h3 className='text-white font-black text-xs uppercase tracking-widest mb-8'>Company</h3>
              <ul className='space-y-4'>
          ...
          <Reveal delay={0.3} distance={30}>
            <nav aria-label='Legal links'>
              <h3 className='text-white font-black text-xs uppercase tracking-widest mb-8'>Legal</h3>
              <ul className='space-y-4'>
                {legalLinks.map((link) => (
                  <li key={link.href}>
                    <Link
        ...
        <Reveal delay={0.5} className='mt-20 pt-10 border-t border-white/5'>
          <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
            <p className='text-gray-500 text-xs tracking-widest uppercase'>
              © {year} <span className='text-white font-black'>{COMPANY_NAME}</span>. ALL RIGHTS RESERVED.
            </p>
            <div className='flex gap-8'>
              <p className='text-[10px] text-gray-600 uppercase tracking-widest'>Designed by Zebotix Studio</p>
              <p className='text-[10px] text-gray-600 uppercase tracking-widest'>Built with Next.js 16 + React 19</p>
            </div>
          </div>
        </Reveal>
      </div>
