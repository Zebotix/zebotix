      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-24">
          ...
          <Reveal delay={0.3}>
            <p className="text-zinc-400 text-lg leading-relaxed">
              We follow a streamlined, highly structured workflow to turn your ambitious ideas into
        ...
        <div className="border-t border-l border-zinc-900 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
          {steps.map((item, index) => (
            <Reveal key={index} delay={0.1 * index} distance={20} className="h-full">
              <div className="h-full tracking-normal border-r border-b border-zinc-900 p-6 sm:p-8 flex flex-col justify-between min-h-55 sm:min-h-70 hover:bg-zinc-900/10 transition-colors group duration-300 relative select-none rounded-none">
