...
export const metadata = {
  ...
  description: 'Learn how Zebotix uses cookies and tracking technologies to optimize your experience.',
};
              ...
              <>
                ...
                <section id="how-we-use">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      <strong>Preference cookies:</strong> Remember your choices such as language and theme selection.
                    </li>
                  </ul>
                </section>
