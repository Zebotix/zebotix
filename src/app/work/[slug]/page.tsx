...
import { PORTFOLIOS, COMPANY_NAME, SITE_URL } from '@/lib/constants';
            ...
            <Reveal delay={0.2}>
              <div className='bg-zebotix-darkGray p-10 rounded-[32px] border border-white/5 shadow-2xl sticky top-32'>
                ...
                <div className='mt-10 pt-10 border-t border-white/5'>
                  ...
                  <div className='flex flex-wrap gap-3'>
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className='px-4 py-2 bg-white/5 rounded-xl text-xs font-bold text-white border border-white/5'
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <Button
                  asChild
                  size='lg'
                  className='w-full mt-10 bg-zebotix-blue hover:bg-blue-600 h-14 text-lg font-bold rounded-2xl'
                >
