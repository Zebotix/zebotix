    ...
    <div className="p-8 md:p-12 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-zinc-900 border border-zinc-800 p-6 shadow-xl">
          <h2 className="text-zinc-400 text-sm font-semibold uppercase tracking-wider mb-2">Total Leads</h2>
          <p className="text-4xl font-black">{leadsCount}</p>
        </div>
        
        <div className="bg-zinc-900 border border-zinc-800 p-6 shadow-xl">
          <h2 className="text-zinc-400 text-sm font-semibold uppercase tracking-wider mb-2">Portfolios</h2>
          <p className="text-4xl font-black">{portfoliosCount}</p>
        </div>
        
        <div className="bg-zinc-900 border border-zinc-800 p-6 shadow-xl">
          <h2 className="text-zinc-400 text-sm font-semibold uppercase tracking-wider mb-2">Blog Posts</h2>
