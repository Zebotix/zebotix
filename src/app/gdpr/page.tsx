...
export const metadata = {
  title: 'GDPR & DPA Compliance | Zebotix',
            ...
            {dbPage ? (
              ...
              <>
                ...
                <section id="processor-resp">
                  <h3 className="text-xl font-bold text-white mb-3">3. Processor Responsibilities</h3>
                  <p>Zebotix will process personal data only under documented instructions, maintain security measures, and notify data breaches within 72 hours.</p>
                </section>
              </>
            )}
          </div>
