...
export const metadata = {
  ...
  description: 'Zebotix values your privacy. Learn how we collect, use, and protect your information.',
};
            ...
            {dbPage ? (
              ...
              <>
                ...
                <section id="your-rights">
                  <h2 className="text-2xl font-black text-white mb-3">6. Your Rights (GDPR/EU Clients)</h2>
                  <p>
