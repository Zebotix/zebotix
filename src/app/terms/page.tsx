...
export const metadata = {
  ...
  description: 'Zebotix Terms and Conditions governing services, pricing, IP, and project cancellations.',
};
          ...
          {dbPage?.updatedAt && (
            <Reveal delay={0.1}>
              <p className="text-sm text-zinc-550">
                Last updated: <strong>{new Date(dbPage.updatedAt).toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</strong>
              </p>
            </Reveal>
          )}
        </header>
          ...
          <div className="prose prose-invert max-w-none text-zinc-400 text-base leading-relaxed space-y-6">
            {dbPage ? (
              ...
              <>
                ...
                <section id="services">
                  <h3 className="text-xl font-bold text-white mb-3">2. Services &amp; Deliverables</h3>
                  <p>
                ...
                <section id="ip">
                  <h3 className="text-xl font-bold text-white mb-3">4. Intellectual Property (IP)</h3>
                  <p>
                ...
                <section id="revisions">
                  ...
                  <p>
                    ...
                    functionality are billed at standard hourly or fixed rates.
                  </p>
                </section>
                ...
                <section id="liability">
                  ...
                  <p>
                    Zebotix provides a 30-day bug-fix warranty after launch. Our total liability is capped at
