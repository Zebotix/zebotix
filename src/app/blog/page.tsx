...
export const metadata: Metadata = {
  ...
  description: 'Insights, tutorials, and updates from the Zebotix team on AI, web development, and digital strategy.',
};
                ...
                <article className="group bg-zebotix-darkGray rounded-3xl overflow-hidden border border-white/5 hover:border-zebotix-blue/40 transition-all duration-500 shadow-2xl h-full flex flex-col">
                  ...
                  <div className="p-8 grow flex flex-col">
                    ...
                    <div className="mt-auto flex items-center justify-between pt-6 border-t border-white/5">
                      ...
                      <span className="text-sm font-bold text-white group-hover:text-zebotix-blue transition-colors">Read More →</span>
                    </div>
                  </div>
                </article>
              </Reveal>
