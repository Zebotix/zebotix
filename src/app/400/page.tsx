        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
          <section className='space-y-6'>
            ...
            <p className='text-lg text-gray-300 max-w-xl'>
              Oops — we couldn't find the page you're looking for. It may have been moved, renamed,
              or never existed. Don't worry — here are a few options to get you back on track.
            </p>
            ...
            <div className='mt-4 text-sm text-gray-400'>
              <p>
                ...
                <a href='mailto:legal@zebotix.com' className='text-indigo-300 hover:underline'>
                  legal@zebotix.com
                </a>{' '}
                or{' '}
                <a href='mailto:privacy@zebotix.com' className='text-indigo-300 hover:underline'>
                  privacy@zebotix.com
                </a>
                .
              </p>
